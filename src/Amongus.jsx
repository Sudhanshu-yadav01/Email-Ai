...
const Amongus = () => {
  return (
    <StyledWrapper>
      <button>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="40px" height="40px">
          <rect width={36} height={36} x={0} y={0} fill="#8bec46ff" />
        ...
        <span className="play">Reply</span>
      </button>
    </StyledWrapper>
  );
}
